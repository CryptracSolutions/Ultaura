...
- Free Trial: $0 for 3 days, unlimited minutes, 1 phone line, up to 3 reminders per line
...
Use choose_overage_action to record the user's decision after overage or trial prompts.`,
  compressed: `## Plans
Current: {currentPlanLabel} ({accountStatusLabel}). Free Trial unlimited min/3 days + 3 reminders/line; Care $39/mo (300 min, 1 line, 3 reminders/line); Comfort $99/mo (900 min, 2 lines, 10 reminders/line); Family $199/mo (2200 min, 4 lines, unlimited reminders); PAYG $0.15/min (4 lines, unlimited reminders).
