...
Use choose_overage_action to record the user's decision after overage or trial prompts.`,
  compressed: `## Plans
Current: {currentPlanLabel} ({accountStatusLabel}). Free Trial 20 min/day for 14 days + 5 reminders/line; Care $19/mo (200 min, 1 line, 5 reminders/line); Comfort $49/mo (600 min, 2 lines, 10 reminders/line); Family $99/mo (1200 min, 4 lines, unlimited reminders); PAYG $0.15/min (4 lines, unlimited reminders).
