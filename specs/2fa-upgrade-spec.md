...
**Author:** Kilo (automated spec generation)

### Revision History

| Revision | Date       | Summary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| -------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Draft v1 | 2026-03-01 | Initial spec covering SMS MFA, nudge banner, trusted device, and email MFA analysis.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Draft v2 | 2026-03-01 | 14 validated fixes applied: (1) Timing-safe HMAC comparison in `verifyTrustedDeviceToken()`. (2) Replaced `/api/auth/trust-device` API route with server actions to avoid CSRF issues. (3) Added `signOutAction` server action so HttpOnly trusted-device cookie is cleared on sign-out. (4) Removed middleware trusted-device code block — Edge Runtime cannot use Node.js `crypto`. (5) Added "Out of Scope" section with recovery codes deferral and lockout recovery path. (6) Fixed phone enrollment flow — `mfa.enroll()` does NOT auto-send SMS; explicit `mfa.challenge()` required. (7) Reduced duplicate API calls in `check-requires-mfa.ts` by accepting optional `userId`/`factorIds` params. (8) Moved `PhoneNumberInput` from `src/components/ui/` to `src/core/ui/` (correct location for custom UI primitives). (9) Removed `Secure` flag requirement from `mfa-nudge-dismissed` cookie — `setCookie` utility doesn't support it. (10) Documented `ENVIRONMENT` env var dependency for server-side cookie Secure flags. (11) Added rate limiting analysis for trust-device action. (12) Added test coverage for server actions (`setTrustedDeviceAction`, `clearTrustedDeviceAction`, `signOutAction`). (13) Combined phone enrollment from 3 steps to 2 steps (name + phone in single step) to match TOTP flow. (14) Ensured Out of Scope section is numbered correctly. |
| Draft v3 | 2026-03-01 | 8 validated fixes applied: (1) Replaced `getSupabaseServerClient` with correct `getSupabaseServerActionClient` import in all server action files. (2) Added full try-catch around `isTrustedDevice()` call in `check-requires-mfa.ts` and wrapped entire `verifyTrustedDeviceToken()` body in try-catch. (3) Fixed `useSignOut` to call both server action AND `client.auth.signOut()` to preserve `AuthChangeListener` event flow. (4) Fixed `require-session.ts` variable reference — use internal fallback instead of unavailable `user` variable. (5) Moved server action files from `src/lib/server/actions/` to `src/lib/ultaura/` to match established codebase patterns. (6) Completed File Index with missing entries and test files subsection. (7) Fixed stale function name `signTrustedDeviceToken` → `generateTrustedDeviceToken`. (8) Updated edge case text to reflect implemented try-catch in `verifyTrustedDeviceToken()`.                                                                                                                                                                                                                                                                                                                                                                                                                                              |
