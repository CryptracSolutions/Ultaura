...
import { markHealthDisclosurePrivateRouter } from './mark-health-disclosure-private.js';
import { healthConsentRouter } from './health-consent.js';
import { queueHealthSuggestionRouter } from './queue-health-suggestion.js';
...
toolsRouter.use('/', recordingConsentRouter);
toolsRouter.use('/', sharingConsentRouter);
...
toolsRouter.use('/mark_health_disclosure_private', markHealthDisclosurePrivateRouter);
toolsRouter.use('/', healthConsentRouter);
toolsRouter.use('/queue_health_suggestion', queueHealthSuggestionRouter);
