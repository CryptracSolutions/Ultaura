...
const TOOL_ALLOWLISTS: Record<string, string[]> = {
  ...
  log_segment_engagement: ['segmentType', 'completed', 'storyArcId', 'chapterCompleted'],
  manage_story_arc: ['action', 'storyArcId', 'storyType'],
  store_life_chapter: ['chapterType'],
  log_mood_snapshot: ['moodStart', 'moodEnd', 'trajectory', 'energyLevel'],
  update_content_preference: ['contentType', 'preferenceChange'],
  update_relationship: ['action'],
  mark_relationship_deceased: ['action'],
  log_cognitive_observation: ['observationType', 'severity', 'isNovel'],
  adjust_accessibility: ['setting', 'value', 'source'],
  store_milestone: ['milestoneType', 'isRecurring', 'milestoneId'],
  mark_milestone_celebrated: ['milestoneId'],
  log_health_mention: ['category', 'severity', 'triggersAlert'],
  mark_health_disclosure_private: ['suppressionScope'],
  queue_health_suggestion: ['suggestionType', 'suggestionMode', 'confidenceLabel', 'action'],
  store_memory: ['action', 'version'],
  update_memory: ['action', 'version', 'matchType', 'result'],
  grant_health_consent: ['resultingConsentStatus', 'effectiveScope'],
  deny_health_consent: ['resultingConsentStatus', 'effectiveScope'],
  revoke_health_consent: ['resultingConsentStatus', 'effectiveScope'],
  grant_memory_consent: [],
  deny_memory_consent: [],
  grant_recording_consent: [],
  deny_recording_consent: [],
  revoke_recording_consent: [],
  set_recording_preference_permanent: ['neverAsk'],
  set_sharing_tier: ['tier', 'consent'],
  get_sharing_tier: [],
  enable_family_sharing: [],
  forget_memory: ['result', 'matchType'],
  mark_private: ['matchType', 'result'],
  mark_topic_private: [],
  exclude_memory_topic: ['category', 'affectedMemories'],
  include_memory_topic: ['category', 'restoredMemories'],
