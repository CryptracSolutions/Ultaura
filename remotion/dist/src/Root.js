...
const totalSceneDuration = Object.values(theme.sections).reduce((acc, section) => acc + section.duration, 0);
const calculatedDuration = totalSceneDuration - (numberOfTransitions * transitionDuration);
export const RemotionRoot = () => {
    return (_jsx(_Fragment, { children: _jsx(Composition, { id: "UltauraPromo", component: UltauraPromo, durationInFrames: calculatedDuration, fps: theme.fps, width: theme.dimensions.width, height: theme.dimensions.height }) }));
};
