...
import { GradientBackground, PhoneFrame, Waveform, AnimatedText, SceneLayout, ContentArea, TextArea, } from "../components";
export const AICallsScene = () => {
    const frame = useCurrentFrame();
    const { fps } = useVideoConfig();
    // Pulse animation for active indicator - more pronounced
    const pulseOpacity = interpolate(Math.sin(frame * 0.25), [-1, 1], [0.3, 1]);
    const pulseScale = interpolate(Math.sin(frame * 0.25), [-1, 1], [0.7, 1.3]);
    const pulseGlow = interpolate(Math.sin(frame * 0.25), [-1, 1], [0, 15]);
    // Avatar glow animation
    const avatarGlow = interpolate(Math.sin(frame * 0.08), [-1, 1], [30, 60]);
    // Speaking indicator - voice bars inside avatar
    const voiceBars = [0, 1, 2, 3, 4].map((i) => {
        const phase = (i / 5) * Math.PI * 2;
        return interpolate(Math.sin((frame * 0.2) + phase), [-1, 1], [8, 25]);
    });
    ...
    return (_jsxs(SceneLayout, { background: _jsx(GradientBackground, { variant: "mesh" }), children: [_jsx(ContentArea, { children: _jsx(PhoneFrame, { delay: 0, scale: 0.95, tiltIntensity: 0.8, children: _jsxs("div", { style: {
                            width: "100%",
                            height: "100%",
                            ...
                            paddingTop: 50,
                                    ...
                                    transform: `translateY(${interpolate(activeIndicatorEntrance, [0, 1], [-10, 0])}px)`,
                                            ...
                                            fontWeight: 600,
                                            letterSpacing: 0.5,
                                        }, children: "Active Call" })] }), _jsxs("div", { style: {
                                    position: "relative",
                                    width: 100,
                                    height: 100,
                                    marginBottom: 18,
                                    ...
                                    opacity: interpolate(avatarEntrance, [0, 1], [0, 1]),
                                            ...
                                            overflow: "hidden",
                                                ...
                                                gap: 3,
                                                height: 30,
                                            }, children: voiceBars.map((height, i) => (_jsx("div", { style: {
                                                    width: 4,
                                                    height,
                                                    borderRadius: 2,
                                                    background: "rgba(255, 255, 255, 0.9)",
                                                } }, i))) }) })] }), _jsx(Sequence, { from: 20, layout: "none", children: _jsx("div", { style: {
                                    ...
                                    }, children: "Ara" }) }), _jsx(Sequence, { from: 25, layout: "none", children: _jsx("div", { style: {
                                        fontFamily: theme.fonts.body,
                                        fontSize: 13,
                                        color: theme.colors.textSecondary,
                                        marginBottom: 25,
                                        opacity: interpolate(frame - 25, [0, 15], [0, 1], { extrapolateRight: "clamp" }),
                                    }, children: "Warm & Nurturing Voice" }) }), _jsx("div", { style: {
                                    transform: `scale(${waveformEntrance})`,
                                    opacity: waveformEntrance,
                                }, children: _jsx(Waveform, { width: 220, height: 50, bars: 14, variant: "glow", entranceDelay: 30 }) }), _jsxs("div", { style: {
                                    marginTop: 22,
                                    fontFamily: theme.fonts.body,
                                    fontSize: 32,
                                    fontWeight: 300,
                                    ...
                                    letterSpacing: 2,
                                }, children: [Math.floor((Math.max(0, frame - 60)) / fps / 60), ":", String(Math.floor((Math.max(0, frame - 60) / fps) % 60)).padStart(2, "0")] }), _jsx("div", { style: {
                                    marginTop: 25,
                                    ...
                                    }, children: _jsx("svg", { width: "30", height: "30", viewBox: "0 0 24 24", fill: "white", children: _jsx("path", { d: "M12 9c-1.6 0-3.15.25-4.6.72v3.1c0 .39-.23.74-.56.9-.98.49-1.87 1.12-2.66 1.85-.18.18-.43.28-.7.28-.28 0-.53-.11-.71-.29L.29 13.08a.956.956 0 01-.29-.7c0-.28.11-.53.29-.71C3.34 8.78 7.46 7 12 7s8.66 1.78 11.71 4.67c.18.18.29.43.29.71 0 .28-.11.53-.29.71l-2.48 2.48c-.18.18-.43.29-.71.29-.27 0-.52-.11-.7-.28a11.27 11.27 0 00-2.67-1.85.996.996 0 01-.56-.9v-3.1C15.15 9.25 13.6 9 12 9z" }) }) }) })] }) }) }), _jsxs(TextArea, { children: [_jsx(Sequence, { from: 120, layout: "none", children: _jsx(AnimatedText, { text: "Friendly check-ins.", style: {
                                fontSize: 36,
                                fontWeight: 600,
                                color: theme.colors.textPrimary,
                                lineHeight: 1.4,
                            }, animationType: "wordReveal" }) }), _jsx(Sequence, { from: 145, layout: "none", children: _jsx(AnimatedText, { text: "Natural conversations.", style: {
                                fontSize: 36,
                                fontWeight: 600,
                                color: theme.colors.textPrimary,
                                lineHeight: 1.4,
                            }, animationType: "wordReveal" }) }), _jsx(Sequence, { from: 170, layout: "none", children: _jsx(AnimatedText, { text: "Every single day.", style: {
                                fontSize: 36,
                                fontWeight: 700,
