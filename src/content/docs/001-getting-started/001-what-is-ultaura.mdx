...
Every new account starts with a 14-day trial and up to 20 call minutes per day.

If the daily cap is hit, new calls are blocked until the next day in your loved one's local timezone. In dashboard call actions, you may see a cap or access error until minutes reset or you upgrade.
...
If you leave onboarding, sign back in and return to [/onboarding](/onboarding) to continue. If you cancel checkout during onboarding, Ultaura returns you to setup with your saved progress.
