...
description: Learn everything about Authentication in JP3
---

JP3 uses Supabase to manage authentication within your application.
...
providers
 - **Customization** - an overview of how JP3 works so that you can adapt
