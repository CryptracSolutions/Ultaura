---
title: Clone the JP3 SaaS boilerplate repository
label: Clone the repository
description: Learn how to clone the JP3 repository and install the NodeJS dependencies.
---

If you have bought a license for JP3, you have access to all the
repositories built by the JP3 team. In this document, we will learn how
...
Now, we can add the original JP3 repository as "upstream" so we can fetch updates from the main repository:
