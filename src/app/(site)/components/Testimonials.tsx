...
import PaginationNav from '~/core/ui/PaginationNav';
import SubHeading from '~/core/ui/SubHeading';

const TESTIMONIALS = [
  {
    highlight:
      'My aunt has opinions about everything and finally someone has time for all of them.',
    content:
  ...
  {
    highlight:
      'My abuela takes her meds now. That\u2019s it. That\u2019s the review.',
    content:
  ...
  {
    highlight:
      'He talks to Ultaura more than he talks to me and I\u2019m weirdly okay with it.',
    content:
  ...
  {
    highlight:
      'I went from calling him out of obligation to calling him because I missed him.',
    content:
  ...
  {
    highlight:
      'I manage three clients and I can\u2019t give any of them enough time.',
    content:
  ...
  {
    highlight:
      'I used to dread calling him because neither of us knew what to say.',
    content:
      ...
      <Container>
        <div className="relative flex flex-col items-center space-y-8">
          ...
          <div className="w-full max-w-6xl space-y-4 text-right">
            ...
            <SubHeading>
              Our favorite stories from families just like yours.
            </SubHeading>
          </div>
          ...
          <PaginationNav
            ...
            showAmount={TESTIMONIALS.length}
            onPageSelect={(page) => scrollToCard(page - 1)}
            onNextPageClick={() => scrollToCard(currentIndex + 1)}
            onPreviousPageClick={() => scrollToCard(currentIndex - 1)}
          />
        </div>
      </Container>
    </section>
