...
const SiteHeader = () => {
  ...
  return (
    <>
      {/* Mobile header: matches open menu header 1:1 (px-4, py-3, border-b, logo h-10, hamburger p-2) */}
      ...
      {/* Desktop header - wrapper hides on mobile (Container doesn't accept className) */}
