  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-semibold text-foreground">Edit Schedule</h1>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-10 pr-4 py-3 rounded-lg border border-input bg-background text-foreground appearance-none focus:border-primary focus:ring-2 focus:ring-ring focus:outline-none"
            >
