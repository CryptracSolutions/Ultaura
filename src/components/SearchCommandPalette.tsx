    ...
    <Command shouldFilter={false} className="flex h-full w-full flex-col">
      {externalQuery === undefined && (
        <Command.Input
          ...
          className="mx-3 mt-3 flex h-11 w-[calc(100%-1.5rem)] rounded-md border border-input bg-background px-3 py-3 text-sm shadow-sm outline-none placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50"
          placeholder="Search..."
          aria-label="Search"
          autoFocus
        />
