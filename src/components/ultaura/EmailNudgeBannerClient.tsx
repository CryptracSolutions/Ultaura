...
export function EmailNudgeBannerClient() {
  ...
  const handleDismiss = () => {
    ...
    setCookie('email-nudge-dismissed', now.toISOString(), {
      path: '/dashboard',
    ...
    <div className="rounded-xl border border-border bg-primary/10 py-2.5 px-4">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="font-medium text-foreground text-sm">
              <Trans i18nKey={'profile:emailNudgeHeading'} />
            </div>

            <div className="text-xs text-muted-foreground">
              <Trans i18nKey={'profile:emailNudgeDescription'} />
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 pl-10 sm:pl-0 sm:ml-auto">
          <Link
            href="/dashboard/settings/profile/email"
          ...
          >
            <Trans i18nKey={'profile:emailNudgeCta'} />
